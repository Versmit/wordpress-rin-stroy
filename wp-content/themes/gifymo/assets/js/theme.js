...
(function ($) {
    ...
    var OpalThemeSmoothMenu = function () {
        function OpalThemeSmoothMenu() {
            ...
            gifymoJS.smoothCallback = function (selector) {
    ...
    jQuery('.breadcrumb a').each(function () {
        if (jQuery(this).attr('href') == 'https://rin-stroy.ru/shop/') {
          jQuery(this).closest('span').addClass('toHide');  
        }
    });
