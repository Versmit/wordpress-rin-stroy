...
class OSF_Customize_Control_Background_Position extends WP_Customize_Control {
	...
	public function render_content() {
		$options = array(
			array(
				'left top'   => array(
					'label' => __( 'Top Left', 'gifymo-core' ),
					'icon'  => 'dashicons dashicons-arrow-left-alt'
				),
				'center top' => array(
					'label' => __( 'Top', 'gifymo-core' ),
					'icon'  => 'dashicons dashicons-arrow-up-alt'
				),
				'right top'  => array(
					'label' => __( 'Top Right', 'gifymo-core' ),
					'icon'  => 'dashicons dashicons-arrow-right-alt'
				),
			),
			array(
				'left center'   => array(
					'label' => __( 'Left', 'gifymo-core' ),
					'icon'  => 'dashicons dashicons-arrow-left-alt'
				),
				'center center' => array(
				...
				'right center'  => array(
					'label' => __( 'Right', 'gifymo-core' ),
					'icon'  => 'dashicons dashicons-arrow-right-alt'
				),
			),
			array(
				'left bottom'   => array(
					'label' => __( 'Bottom Left', 'gifymo-core' ),
					'icon'  => 'dashicons dashicons-arrow-left-alt'
				),
				'center bottom' => array(
					'label' => __( 'Bottom', 'gifymo-core' ),
					'icon'  => 'dashicons dashicons-arrow-down-alt'
				),
				'right bottom'  => array(
					'label' => __( 'Bottom Right', 'gifymo-core' ),
					'icon'  => 'dashicons dashicons-arrow-right-alt'
				),
			),
		);
