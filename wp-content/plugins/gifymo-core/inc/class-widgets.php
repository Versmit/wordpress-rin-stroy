...
class OSF_WP_Widget_Recent_Posts extends WP_Widget_Recent_Posts {
    ...
    public function widget($args, $instance) {
        ...
        $title = (!empty($instance['title'])) ? $instance['title'] : __('Recent Posts', 'gifymo-core');
        ...
        <ul>
            <?php foreach ($r->posts as $recent_post) : ?>
                ...
                $title      = (!empty($post_title)) ? $post_title : __('(no title)', 'gifymo-core');
                ?>
                <li class="item-recent-post">
                    <?php if (has_post_thumbnail($recent_post->ID)): ?>
                        <div class="thumbnail-post"><?php echo get_the_post_thumbnail($recent_post->ID, 'gifymo-thumbnail'); ?></div>
                    <?php endif; ?>
