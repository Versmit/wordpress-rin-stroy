...
//Social
add_action('woocommerce_single_product_summary', 'osf_single_product_social', 30);
...
//    add_action('woocommerce_before_shop_loop_item_title', 'osf_woocommerce_product_loop_label_end', 30);
     ...
     */
    add_action('osf_woocommerce_product_loop_action', 'woocommerce_template_loop_add_to_cart', 5);

    // Wishlist
    add_action('osf_woocommerce_product_loop_action', 'osf_woocommerce_product_loop_wishlist_button', 15);

    // Compare
    add_action('osf_woocommerce_product_loop_action', 'osf_woocommerce_product_loop_compare_button', 20);
...
function osf_woocommerce_yith_add_quick_view_button() {
    if (osf_is_woocommerce_extension_activated('YITH_WCQV')) {
        ...
        add_action('osf_woocommerce_product_loop_action', array(YITH_WCQV_Frontend::get_instance(), 'yith_add_quick_view_button'), 10);
