...
class OSF_Elementor_Team_Box extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __('Opal Team Box', 'gifymo-core');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'teams',
            [
                'label' => __('Team Item', 'gifymo-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => __('https://www.facebook.com/opalwordpress', 'gifymo-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => __('https://twitter.com/opalwordpress', 'gifymo-core'),
        ...
        $this->add_control(
            'youtube',
            [
                'label'       => __('Youtube', 'gifymo-core'),
                'placeholder' => __('https://www.youtube.com/user/WPOpalTheme', 'gifymo-core'),
        ...
        $this->add_control(
            'google',
            [
                'label'       => __('Google', 'gifymo-core'),
                'placeholder' => __('https://plus.google.com/u/0/+WPOpal', 'gifymo-core'),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Icon Social', 'gifymo-core'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
