...
class OSF_Elementor_Header_Group extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __('Opal Header Group', 'gifymo-core');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'show_wishlist',
            [
                'label' => __('Show wishlist', 'gifymo-core'),
        ...
        $this->add_control(
            'show_search',
            [
                'label' => __('Show search form', 'gifymo-core'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->add_control(
            'show_account',
            [
                'label' => __('Show account', 'gifymo-core'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->add_control(
            'show_cart',
            [
                'label' => __('Show cart', 'gifymo-core'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->start_controls_section(
            'wishlist_config',
            [
                'label'     => __('WooCommerce Wishlist', 'gifymo-core'),
                'condition' => [
                    'show_wishlist!' => '',
                ],
            ]
        ...
        $this->add_control(
            'show_subtotal',
            [
                'label' => __('Show Total', 'gifymo-core'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __('Wishlist', 'gifymo-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'   => __('Text', 'gifymo-core'),
                'type'    => Controls_Manager::TEXT,
                'default' => __('Account', 'gifymo-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'   => __('Choose Icon', 'gifymo-core'),
                'type'    => Controls_Manager::ICON,
                'default' => 'opal-icon-shopping-bag',
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => __('Wishlist Style', 'gifymo-core'),
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Background Hover Color', 'gifymo-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Title Hover Color', 'gifymo-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __('Hover Color', 'gifymo-core'),
                'type'  => Controls_Manager::COLOR,
        ...
        $this->start_controls_section(
            'section_input_style',
            [
                'label'     => __('Search Form Style', 'gifymo-core'),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'show_search!' => '',
                ],
        ...
        $this->add_control(
            'button_border_width',
            [
                'label'     => __('Border Size', 'gifymo-core'),
                'type'      => Controls_Manager::DIMENSIONS,
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => __('Account Style', 'gifymo-core'),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'show_account' => 'yes',
                ],
        ...
        $this->add_control(
            'indicator_style',
            [
                'label'     => __('INDICATOR', 'gifymo-core'),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'indicator_color',
            [
                'label'     => __('Indicator Color', 'gifymo-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            'section_lable_style',
            [
                'label'     => __('Cart Style', 'gifymo-core'),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'show_cart' => 'yes',
                ],
    ...
    protected function render_cart() {
        ...
        <div class="site-header-cart menu d-flex">
            <a data-toggle="toggle" class="cart-contents header-button" href="<?php echo esc_url(wc_get_cart_url()); ?>">
                ...
                <span class="header-button-text"><?php echo esc_html($settings['title_cart']); ?></span>
    ...
    protected function render_account() {
        ...
        $icon_account = !empty($settings['icon_account']) ? '<i class="' . esc_attr($settings['icon_account']) . '"></i>' : '';
        $account_text = '';
        $current_user = wp_get_current_user();

        if (!is_user_logged_in()) {
            $account_text = !empty($settings['text_account']) ? '<span class="text-account header-button-text d-block">' . $settings['text_account'] . '</span>' : '';
        } else {
            $current_user = wp_get_current_user();
            $account_text = '<span class="text-account header-button-text d-block">' . esc_html('Welcome') . ' <strong>' . $current_user->display_name . '</strong></span>';
        }
        ?>
        <div class="site-header-account">
            <?php
            printf('<a class="opal-header-account header-button" href="' . esc_url($account_link) . '"> %1$s %2$s</a>',
                $icon_account,
                $account_text);
            ?>
    ...
    protected function render_form_login() { ?>
        ...
        <div class="login-form-head pb-1 mb-3 bb-so-1 bc d-flex align-items-baseline justify-content-between">
            <span class="login-form-title"><?php esc_attr_e('Sign in', 'gifymo-core') ?></span>
            <span class="pull-right">
                <a class="register-link" href="<?php echo esc_url(wp_registration_url()); ?>"
                   title="<?php esc_attr_e('Register', 'gifymo-core'); ?>"><?php esc_attr_e('Create an Account', 'gifymo-core'); ?></a>
            </span>
        </div>
        <form class="opal-login-form-ajax" data-toggle="validator">
            <p>
                <label><?php esc_attr_e('Username or email', 'gifymo-core'); ?>
                    <span class="required">*</span></label>
                <input name="username" type="text" required placeholder="<?php esc_attr_e('Username', 'gifymo-core') ?>">
            </p>
            <p>
                <label><?php esc_attr_e('Password', 'gifymo-core'); ?> <span class="required">*</span></label>
                <input name="password" type="password" required placeholder="<?php esc_attr_e('Password', 'gifymo-core') ?>">
            </p>
            <button type="submit" data-button-action class="btn btn-primary btn-block w-100 mt-1">
                <span><?php esc_html_e('Login', 'gifymo-core') ?></span></button>
            <input type="hidden" name="action" value="osf_login">
            <?php wp_nonce_field('ajax-osf-login-nonce', 'security-login'); ?>
        </form>
        <div class="login-form-bottom">
            <a href="<?php echo wp_lostpassword_url(get_permalink()); ?>" class="mt-2 lostpass-link d-inline-block" title="<?php esc_attr_e('Lost your password?', 'gifymo-core'); ?>"><?php esc_attr_e('Lost your password?', 'gifymo-core'); ?></a>
        </div>
        <?php
    ...
    protected function render_dashboard() { ?>
        <?php if (has_nav_menu('my-account')) : ?>
            <nav class="social-navigation" role="navigation" aria-label="<?php esc_attr_e('Dashboard', 'gifymo-core'); ?>">
                <?php
                wp_nav_menu(array(
        ...
        <?php else: ?>
            <ul class="account-dashboard">
                ...
                <?php if (osf_is_woocommerce_activated()): ?>
                    <li>
                        <a href="<?php echo esc_url(wc_get_page_permalink('myaccount')); ?>" title="<?php esc_html_e('Dashboard', 'gifymo-core'); ?>"><?php esc_html_e('Dashboard', 'gifymo-core'); ?></a>
                    </li>
                    <li>
                        <a href="<?php echo esc_url(wc_get_account_endpoint_url('orders')); ?>" title="<?php esc_html_e('Orders', 'gifymo-core'); ?>"><?php esc_html_e('Orders', 'gifymo-core'); ?></a>
                    </li>
                    <li>
                        <a href="<?php echo esc_url(wc_get_account_endpoint_url('downloads')); ?>" title="<?php esc_html_e('Downloads', 'gifymo-core'); ?>"><?php esc_html_e('Downloads', 'gifymo-core'); ?></a>
                    </li>
                    <li>
                        <a href="<?php echo esc_url(wc_get_account_endpoint_url('edit-address')); ?>" title="<?php esc_html_e('Edit Address', 'gifymo-core'); ?>"><?php esc_html_e('Edit Address', 'gifymo-core'); ?></a>
                    </li>
                    <li>
                        <a href="<?php echo esc_url(wc_get_account_endpoint_url('edit-account')); ?>" title="<?php esc_html_e('Account Details', 'gifymo-core'); ?>"><?php esc_html_e('Account Details', 'gifymo-core'); ?></a>
                    </li>
                <?php else: ?>
                    <li>
                        <a href="<?php echo esc_url(get_dashboard_url(get_current_user_id())); ?>" title="<?php esc_html_e('Dashboard', 'gifymo-core'); ?>"><?php esc_html_e('Dashboard', 'gifymo-core'); ?></a>
                    </li>
                <?php endif; ?>
                <li>
                    <a title="<?php esc_html_e('Log out', 'gifymo-core'); ?>" class="tips" href="<?php echo esc_url(wp_logout_url(home_url())); ?>"><?php esc_html_e('Log Out', 'gifymo-core'); ?></a>
                </li>
            </ul>
        <?php endif;
