...
class OSF_Elementor_Flip_Box extends Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Opal Flip Box', 'gifymo-core' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Front', 'gifymo-core' ),
			]
		);

		$this->start_controls_tabs( 'side_a_content_tabs' );

		$this->start_controls_tab( 'side_a_content_tab', [ 'label' => __( 'Content', 'gifymo-core' ) ] );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __( 'This is the sub title', 'gifymo-core' ),
...
//				'show_label' => false,
		...
		$this->start_controls_tab( 'side_a_background_tab', [ 'label' => __( 'Background', 'gifymo-core' ) ] );
		...
		$this->add_control(
			...
			[
				'label' => __( 'Background Overlay', 'gifymo-core' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Back', 'gifymo-core' ),
			]
		);

		$this->start_controls_tabs( 'side_b_content_tabs' );

		$this->start_controls_tab( 'side_b_content_tab', [ 'label' => __( 'Content', 'gifymo-core' ) ] );
		...
		$this->start_controls_tab( 'side_b_background_tab', [ 'label' => __( 'Background', 'gifymo-core' ) ] );
		...
		$this->add_control(
			'flip_effect',
			[
				'label' => __( 'Flip Effect', 'gifymo-core' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'flip',
				'options' => [
					'flip' => 'Flip',
		...
		$this->add_control(
			'flip_direction',
			[
				'label' => __( 'Flip Direction', 'gifymo-core' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'up',
				'options' => [
					'left' => __( 'Left', 'gifymo-core' ),
					'right' => __( 'Right', 'gifymo-core' ),
					'up' => __( 'Up', 'gifymo-core' ),
					'down' => __( 'Down', 'gifymo-core' ),
				],
				'condition' => [
					'flip_effect!' => [
							'fade',
