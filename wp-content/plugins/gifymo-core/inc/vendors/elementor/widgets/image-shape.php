...
class OSF_Widget_Image_Shape extends Widget_Base {
	...
	public function get_title() {
		return __( 'Image Shape', 'gifymo-core' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_image',
			[
				'label' => __( 'Image Box', 'gifymo-core' ),
			]
		);
		...
		$this->add_control(
			'media_type',
			[
				'label'   => __( 'Media Type', 'gifymo-core' ),
				'type'    => Controls_Manager::SELECT,
				'options' => [
					'image' => __( 'Image', 'gifymo-core' ),
					'svg'   => __( 'SVG Code', 'gifymo-core' ),
				],
				'default' => 'image',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'        => Controls_Manager::TEXT,
				'placeholder' => __( 'Enter your sub-title', 'gifymo-core' ),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'gifymo-core' ),
		...
		$this->add_control(
			...
			[
				'label'        => __( 'Hover Wrapper Animation', 'gifymo-core' ),
		...
		$this->add_control(
			'link_download',
			[
				'label' => __( 'Download Link ?', 'gifymo-core' ),
...
//        control button
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Animation Background', 'gifymo-core' ),
			]
		);
		...
		$this->add_control(
			'hover_animation_bg',
			[
				'label' => __( 'Enable Animation', 'gifymo-core' ),
				'type'  => Controls_Manager::SWITCHER,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::SELECT,
				'options'   => [
					'0' => __( 'Style 1', 'gifymo-core' ),
					'1' => __( 'Style 2', 'gifymo-core' ),
					'2' => __( 'Style 3', 'gifymo-core' ),
				],
				'default'   => '1',
				'condition' => [
		...
		$this->add_control( 'bg_animation_duration',
			[
				'label'     => esc_html__( 'Duration', 'gifymo-core' ),
				'type'      => Controls_Manager::NUMBER,
				'title'     => esc_html__( 'Set the animation duration in milliseconds, default is 1200', 'gifymo-core' ),
				'default'   => 1200,
				'condition' => [
					'hover_animation_bg' => 'yes'
				]
		...
		$this->add_control( 'bg_animation_elasticity',
			[
				'label'     => esc_html__( 'Elasticity', 'gifymo-core' ),
				'type'      => Controls_Manager::NUMBER,
				'default'   => 400,
				'condition' => [
					'hover_animation_bg' => 'yes'
...
//        end control button
		...
		$this->add_control(
			...
			[
				'label'        => __( 'Vertical Alignment', 'gifymo-core' ),
				'type'         => Controls_Manager::SELECT,
				'options'      => [
		...
		$this->add_control(
			'title_color_hover',
			[
				'label'     => __( 'Color Hover (Wrapper)', 'gifymo-core' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Transition Duration', 'gifymo-core' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'max'  => 3,
