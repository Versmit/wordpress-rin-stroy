...
class OSF_Widget_Featured_Box extends Widget_Base {
    ...
    public function get_title() {
        return __('Featured Box', 'gifymo-core');
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_icon',
            [
                'label' => __('Featured Box', 'gifymo-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'label'        => __('Show Icon Background', 'gifymo-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => __('Read more', 'gifymo-core'),
                'separator'   => 'none',
            ]
        );
        $this->add_control(
...
//        );
        ...
        $this->add_control(
            'icon_bg_color',
            [
                'label'     => __('Bg Icon Color', 'gifymo-core'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
