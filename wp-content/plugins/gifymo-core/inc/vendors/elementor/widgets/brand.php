...
class OSF_Elementor_Brand extends OSF_Elementor_Carousel_Base {
    ...
    public function get_title() {
        return __('Opal Brands', 'gifymo-core');
    }
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            'brand_title',
            [
                'label'       => __('Brand title', 'gifymo-core'),
                'type'        => Controls_Manager::TEXT,
                'label_block' => true,
                'default'     => __('Brand Name', 'gifymo-core'),
                'placeholder' => __('Brand Name', 'gifymo-core'),
                'dynamic'     => [
                    'active' => true,
                ],
            ]
        ...
        $repeater->add_control(
            'brand_description',
            [
                'label'       => __('Brand Description', 'gifymo-core'),
                'type'        => Controls_Manager::TEXT,
                'default'     => __('Brand Description', 'gifymo-core'),
                'placeholder' => __('Brand Description', 'gifymo-core'),
                'label_block' => true,
            ]
        );
        $repeater->add_control(
            'brand_heading_image',
            [
                'label'       => __('Brand image', 'gifymo-core'),
        ...
        $repeater->add_control(
            'brand_heading_logo',
            [
                'label'       => __('Brand Logo', 'gifymo-core'),
                'type'        => Controls_Manager::HEADING,
                'label_block' => true,
                'separator'   => 'before',
            ]
        ...
        $this->add_control(
            'brands',
            [
                'label'       => __('Brand Items', 'gifymo-core'),
                'type'        => Controls_Manager::REPEATER,
                'fields'      => $repeater->get_controls(),
                'default'     => [
                    [
                        'brand_title' => __('Brand #1', 'gifymo-core'),
                        'brand_image' => [
                            'url' => Elementor\Utils::get_placeholder_image_src()
                        ],
                        'brand_logo'  => [
                    ...
                    [
                        'brand_title' => __('Brand #2', 'gifymo-core'),
                        'brand_image' => [
                            'url' => Elementor\Utils::get_placeholder_image_src()
                        ],
                        'brand_logo'  => [
                    ...
                    [
                        'brand_title' => __('Brand #3', 'gifymo-core'),
                        'brand_image' => [
                            'url' => Elementor\Utils::get_placeholder_image_src()
                        ],
                        'brand_logo'  => [
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Image Settings', 'gifymo-core'),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'brand_logo_settings',
            [
                'label'     => __('Logo Settings', 'gifymo-core'),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                'name'      => 'brand_logo',
                'label'     => __('Logo Size', 'gifymo-core'),
                // Usage: `{name}_size` and `{name}_custom_dimension`, in this case `brand_image_size` and `brand_image_custom_dimension`.
                'default'   => 'full',
                'separator' => 'none',
            ]
