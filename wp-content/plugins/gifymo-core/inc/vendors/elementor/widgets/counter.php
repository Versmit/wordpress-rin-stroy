...
class OSF_Elementor_Counter extends Widget_Counter {
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'starting_number',
            [
                'label'   => __('Starting Number', 'gifymo-core'),
        ...
        $this->add_control(
            'ending_number',
            [
                'label'   => __('Ending Number', 'gifymo-core'),
                'type'    => Controls_Manager::NUMBER,
                'default' => 100,
            ]
        );
        ...
        $this->add_control(
            'prefix',
            [
                'label'       => __('Number Prefix', 'gifymo-core'),
        ...
        $this->add_control(
            'suffix',
            [
                'label'       => __('Number Suffix', 'gifymo-core'),
                'type'        => Controls_Manager::TEXT,
                'default'     => '',
                'placeholder' => __('Plus', 'gifymo-core'),
            ]
        );
        ...
        $this->add_control(
            'show_icon',
            [
                'label'     => __('Show Icon', 'gifymo-core'),
        ...
        $this->add_control(
            'icon_select',
            [
                'label'     => __('Icon select', 'gifymo-core'),
                'type'      => Controls_Manager::SELECT,
                'default'   => 'use_icon',
                'options'   => [
                    'use_icon'  => __('Use Icon', 'gifymo-core'),
                    'use_image' => __('Use Image', 'gifymo-core'),
                ],
                'condition' => [
                    'show_icon' => 'yes',
                ],
        ...
        $this->add_control(
            'thousand_separator',
            [
                'label'     => __('Thousand Separator', 'gifymo-core'),
                'type'      => Controls_Manager::SWITCHER,
                'default'   => 'yes',
                'label_on'  => __('Show', 'gifymo-core'),
                'label_off' => __('Hide', 'gifymo-core'),
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Separator', 'gifymo-core'),
                'type'      => Controls_Manager::SELECT,
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'type'        => Controls_Manager::TEXT,
                'label_block' => true,
                'default'     => __('Cool Number', 'gifymo-core'),
                'placeholder' => __('Cool Number', 'gifymo-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'        => Controls_Manager::TEXT,
                'label_block' => true,
                'placeholder' => __('Sub Title', 'gifymo-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'placeholder' => __('Description...', 'gifymo-core'),
            ]
        );
        ...
        $this->add_control(
            'position',
            [
                'label'        => __('Content Align', 'gifymo-core'),
                'type'         => Controls_Manager::CHOOSE,
                'options'      => [
                    'left' => [
                        'title' => __('Left', 'gifymo-core'),
        ...
        $this->start_controls_section(
            'section_image',
            [
                'label'     => __('Image & SVG', 'gifymo-core'),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition'  => [
                    'icon_select' => 'use_image',
                    'show_icon'   => 'yes',
