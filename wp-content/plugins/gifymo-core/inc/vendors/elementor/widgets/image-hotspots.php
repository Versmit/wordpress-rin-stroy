...
class OSF_Elementor_Image_Hotspots_Widget extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section('image_hotspots_image_section',
            [
                'label' => esc_html__('Image', 'gifymo-core'),
            ]
        );
        ...
        $this->start_controls_section('image_hotspots_icons_settings',
            [
                'label' => esc_html__('Hotspots', 'gifymo-core'),
            ]
        );
        ...
        $repeater->add_responsive_control('preimum_image_hotspots_main_icons_horizontal_position',
            [
                'label'      => esc_html__('Horizontal Position', 'gifymo-core'),
        ...
        $repeater->add_responsive_control('preimum_image_hotspots_main_icons_vertical_position',
            [
                'label'      => esc_html__('Vertical Position', 'gifymo-core'),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px', 'em', '%'],
                'range'      => [
                    'px' => [
        ...
        $repeater->add_control('image_hotspots_content',
            [
                'label'   => esc_html__('Content to Show', 'gifymo-core'),
                'type'    => Controls_Manager::SELECT,
                'options' => [
                    'text_editor'         => esc_html__('Text Editor', 'gifymo-core'),
                    'elementor_templates' => esc_html__('Elementor Template', 'gifymo-core'),
                ],
                'default' => 'text_editor'
            ]
        );
        ...
        $repeater->add_control('image_hotspots_tooltips_info',
            ['label'       => esc_html__('Infomation', 'gifymo-core'),
             'type'        => Controls_Manager::WYSIWYG,
             'default'     => 'Lorem ipsum',
             'dynamic'     => ['active' => true],
             'label_block' => true,
        ...
        $repeater->add_control('image_hotspots_tooltips_temp',
            [
                'label'     => esc_html__('Teamplate ID', 'gifymo-core'),
        ...
        $repeater->add_control('image_hotspots_link_switcher',
            [
                'label'       => esc_html__('Link', 'gifymo-core'),
                'type'        => Controls_Manager::SWITCHER,
                'description' => esc_html__('Add a custom link or select an existing page link', 'gifymo-core'),
            ]);

        $repeater->add_control('image_hotspots_link_type',
            [
                'label'       => esc_html__('Link/URL', 'gifymo-core'),
                'type'        => Controls_Manager::SELECT,
                'options'     => [
                    'url'  => esc_html__('URL', 'gifymo-core'),
                    'link' => esc_html__('Existing Page', 'gifymo-core'),
                ],
                'default'     => 'url',
                'condition'   => [
        ...
        $repeater->add_control('image_hotspots_url',
            [
                'label'       => esc_html__('URL', 'gifymo-core'),
        ...
        $repeater->add_control('image_hotspots_link_text',
            [
                'label'       => esc_html__('Link Title', 'gifymo-core'),
        ...
        $this->add_control('image_hotspots_icons_animation',
            [
                'label' => esc_html__('Radar Animation', 'gifymo-core'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->start_controls_section('image_hotspots_tooltips_section',
            [
                'label' => esc_html__('Tooltips', 'gifymo-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'   => esc_html__('Trigger', 'gifymo-core'),
                'type'    => Controls_Manager::SELECT,
                'options' => [
                    'click' => esc_html__('Click', 'gifymo-core'),
                    'hover' => esc_html__('Hover', 'gifymo-core'),
                ],
                'default' => 'hover'
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Show Arrow', 'gifymo-core'),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => esc_html__('Show', 'gifymo-core'),
                'label_off' => esc_html__('Hide', 'gifymo-core'),
            ]
        );
        ...
        $this->add_control('image_hotspots_tooltips_distance_position',
            [
                'label'   => esc_html__('Spacing', 'gifymo-core'),
                'type'    => Controls_Manager::NUMBER,
                'title'   => esc_html__('The distance between the origin and the tooltip in pixels, default is 6', 'gifymo-core'),
                'default' => 6,
            ]
        );
        ...
        $this->add_control('image_hotspots_min_width',
            [
                'label'       => esc_html__('Min Width', 'gifymo-core'),
                'type'        => Controls_Manager::SLIDER,
                'range'       => [
                    'px' => [
                        'min' => 0,
                ...
                'description' => esc_html__('Set a minimum width for the tooltip in pixels, default: 0 (auto width)', 'gifymo-core'),
            ]
        );

        $this->add_control('image_hotspots_max_width',
            [
                'label'       => esc_html__('Max Width', 'gifymo-core'),
                'type'        => Controls_Manager::SLIDER,
                'range'       => [
                    'px' => [
                        'min' => 0,
                ...
                'description' => esc_html__('Set a maximum width for the tooltip in pixels, default: null (no max width)', 'gifymo-core'),
            ]
        );

        $this->add_responsive_control('image_hotspots_tooltips_wrapper_height',
            [
                'label'       => esc_html__('Height', 'gifymo-core'),
                'type'        => Controls_Manager::SLIDER,
                'size_units'  => ['px', 'em', '%'],
                'range'       => [
                    'px' => [
        ...
        $this->add_control('image_hotspots_anim',
            [
                'label'       => esc_html__('Animation', 'gifymo-core'),
                'type'        => Controls_Manager::SELECT,
                'options'     => [
                    'fade'  => esc_html__('Fade', 'gifymo-core'),
                    'grow'  => esc_html__('Grow', 'gifymo-core'),
                    'swing' => esc_html__('Swing', 'gifymo-core'),
                    'slide' => esc_html__('Slide', 'gifymo-core'),
                    'fall'  => esc_html__('Fall', 'gifymo-core'),
                ],
                'default'     => 'fade',
                'label_block' => true,
            ]
        ...
        $this->add_control('image_hotspots_anim_dur',
            [
                'label'   => esc_html__('Animation Duration', 'gifymo-core'),
                'type'    => Controls_Manager::NUMBER,
                'title'   => esc_html__('Set the animation duration in milliseconds, default is 350', 'gifymo-core'),
                'default' => 350,
            ]
        );
        ...
        $this->add_control('image_hotspots_delay',
            [
                'label'   => esc_html__('Delay', 'gifymo-core'),
                'type'    => Controls_Manager::NUMBER,
                'title'   => esc_html__('Set the animation delay in milliseconds, default is 10', 'gifymo-core'),
                'default' => 10,
            ]
        );
        ...
        $this->add_control('image_hotspots_hide',
            [
                'label'        => esc_html__('Hide on Mobiles', 'gifymo-core'),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => 'Show',
                'label_off'    => 'Hide',
                'description'  => esc_html__('Hide tooltips on mobile phones', 'gifymo-core'),
                'return_value' => true,
            ]
        );
        ...
        $this->add_control('image_hotspots_infomation_show',
            [
                'label' => esc_html__('Show infomation', 'gifymo-core'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->add_control('image_hotspots_image_border_radius',
            [
                'label'      => esc_html__('Border Radius', 'gifymo-core'),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
        ...
        $this->add_responsive_control('image_hotspots_image_padding',
            [
                'label'      => esc_html__('Padding', 'gifymo-core'),
        ...
        $this->add_responsive_control(
            ...
            [
                'label'     => __('Text Alignment', 'gifymo-core'),
        ...
        $this->add_control('image_hotspots_tooltips_wrapper_color',
            [
                'label'     => esc_html__('Text Color', 'gifymo-core'),
        ...
        $this->add_control('image_hotspots_tooltips_wrapper_background_color',
            [
                'label'     => esc_html__('Background Color', 'gifymo-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_responsive_control('image_hotspots_tooltips_wrapper_margin',
            [
                'label'      => esc_html__('Margin', 'gifymo-core'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
...
//        );
        ...
        $this->start_controls_section('img_hotspots_container_style',
            [
                'label' => esc_html__('Container', 'gifymo-core'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_responsive_control('img_hotspots_container_padding',
            [
                'label'      => esc_html__('Paddding', 'gifymo-core'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
