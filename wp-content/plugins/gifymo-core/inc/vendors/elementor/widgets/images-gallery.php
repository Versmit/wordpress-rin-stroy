...
class OSF_Elementor_Image_Gallery extends Widget_Base {
    ...
    public function get_title() {
        return __('Opal Image Gallery', 'gifymo-core');
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_gallery',
            [
                'label' => __('Image Gallery', 'gifymo-core'),
            ]
        );
        ...
        $repeater->add_control(
            'filter_title',
            [
                'label'       => __('Filter Title', 'gifymo-core'),
                'type'        => Controls_Manager::TEXT,
                'label_block' => true,
                'placeholder' => __('List Item', 'gifymo-core'),
        ...
        $repeater->add_control(
            'wp_gallery',
            [
                'label'      => __('Add Images', 'gifymo-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => [
                    [
                        'filter_title' => __('Gallery 1', 'gifymo-core'),
                    ],
                ],
        ...
        $this->add_control(
            'show_filter_bar',
            [
                'label'     => __('Filter Bar', 'gifymo-core'),
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Infinite Scroll', 'gifymo-core'),
                'type'      => Controls_Manager::SWITCHER,
                'label_off' => __('Off', 'gifymo-core'),
                'label_on'  => __('On', 'gifymo-core'),
            ]
...
//                'exclude'   => ['custom'],
        ...
        $this->add_control(
            ...
            [
                'label'      => __('Image Spacing', 'gifymo-core'),
                'type'       => Controls_Manager::SLIDER,
                'show_label' => false,
                'range'      => [
                    'px' => [
        ...
        $this->add_responsive_control(
            'filter_padding',
            [
                'label'      => __('Filter Padding', 'gifymo-core'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em'],
                'selectors'  => [
        ...
        if ($settings['show_filter_bar'] == 'yes') {
            ...
            <ul class="elementor-galerry__filters"
                ...
                <li class="elementor-galerry__filter elementor-active"
                    data-filter=".__all"><?php echo __('All', 'gifymo-core'); ?></li>
