...
class OSF_Elementor_Nav_Menu extends Widget_Base {
    ...
    public function get_title() {
        return __('Opal Nav Menu', 'gifymo-core');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'type_menu',
                'options' => [
                    'type_menu'     => __('Menu', 'gifymo-core'),
                    'type_location' => __('Location', 'gifymo-core'),
                ],
            ]
        );
        ...
        $this->add_control(
            'location',
            [
                'label'     => __('Location', 'gifymo-core'),
                'type'      => Controls_Manager::SELECT,
                'default'   => '',
                'condition' => [
                    'type_field_menu' => 'type_location'
                ],
                'options'   => wp_parse_args(get_registered_nav_menus(), ['' => esc_html__('', 'gifymo-core')]),
                'separator' => 'after',
            ]
        );
        ...
        if (!empty($menus)) {
            $this->add_control(
                ...
                [
                    ...
                    'separator'    => 'after',
                    'description'  => sprintf(__('Go to the <a href="%s" target="_blank">Menus screen</a> to manage your menus.', 'gifymo-core'), admin_url('nav-menus.php')),
                ]
            );
        } else {
            $this->add_control(
                ...
                [
                    ...
                    'raw'             => sprintf(__('<strong>There are no menus in your site.</strong><br>Go to the <a href="%s" target="_blank">Menus screen</a> to create one.', 'gifymo-core'), admin_url('nav-menus.php?action=edit&menu=0')),
                    'separator'       => 'after',
        ...
        $this->add_control(
            'pointer',
            [
                'label'   => __('Pointer', 'gifymo-core'),
                'type'    => Controls_Manager::SELECT,
                'default' => 'none',
                'options' => [
                    'none'        => __('None', 'gifymo-core'),
                    'underline'   => __('Underline', 'gifymo-core'),
                    'overline'    => __('Overline', 'gifymo-core'),
                    'double-line' => __('Double Line', 'gifymo-core'),
                    'framed'      => __('Framed', 'gifymo-core'),
                    'text'        => __('Text', 'gifymo-core'),
                    'dot'         => __('Dot', 'gifymo-core'),
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'dot_width',
            [
                'label'     => __('Dot Width', 'gifymo-core'),
        ...
        $this->add_responsive_control(
            'dot_height',
            [
                'label'     => __('Dot Height', 'gifymo-core'),
                'type'      => Controls_Manager::SLIDER,
                'selectors' => [
        ...
        $this->add_control(
            'dot_border_radius',
            [
                'label'      => __('Dot Radius', 'gifymo-core'),
        ...
        $this->add_control(
            'indicator',
            [
                'label'        => __('Submenu Indicator', 'gifymo-core'),
                'type'         => Controls_Manager::SELECT,
                'default'      => 'angle',
                'options'      => [
                    'none'          => __('None', 'gifymo-core'),
                    'classic'       => __('Classic', 'gifymo-core'),
                    'chevron'       => __('Chevron', 'gifymo-core'),
                    'chevron_right' => __('Chevron Right', 'gifymo-core'),
                    'angle'         => __('Angle', 'gifymo-core'),
                    'angle_right'   => __('Angle Right', 'gifymo-core'),
                    'plus'          => __('Plus', 'gifymo-core'),
                ],
        ...
        $this->add_responsive_control(
            'indicator_fsize',
            [
                'label'     => __('Indicator Font Size', 'gifymo-core'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'min' => 10,
        ...
        $this->add_responsive_control(
            'indicator_size',
            [
                'label'     => __('Indicator Size', 'gifymo-core'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'min' => 10,
        ...
        $this->add_responsive_control(
            'indicator_padding',
            [
                'label'     => __('Indicator Spacing', 'gifymo-core'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'min' => 10,
        ...
        $this->add_control(
            'enable_divider_menu',
            [
                'label'     => __('Enable Divider', 'gifymo-core'),
        ...
        $this->add_responsive_control(
            'divider_width',
            [
                'label'     => __('Divider Width', 'gifymo-core'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'min' => 10,
        ...
        $this->add_responsive_control(
            'divider_height',
            [
                'label'     => __('Divider Height', 'gifymo-core'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'min' => 10,
        ...
        $this->add_control(
            ...
            [
                'label'      => __('Divider Radius', 'gifymo-core'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%'],
                'selectors'  => [
        ...
        $this->add_responsive_control(
            'subMenusMinWidth',
            [
                'label'     => __('Min width Submenu(px)', 'gifymo-core'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'min' => 50,
        ...
        $this->add_responsive_control(
            'subMenusMaxWidth',
            [
                'label'   => __('Max width Submenu(px)', 'gifymo-core'),
                'type'    => Controls_Manager::SLIDER,
                'range'   => [
                    'px' => [
                        'min' => 100,
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Mobile Dropdown', 'gifymo-core'),
        ...
        $this->add_control(
            ...
            [
                'label'   => __('Enable Mobile Menu', 'gifymo-core'),
                'type'    => Controls_Manager::SWITCHER,
                'default' => 'yes',
            ]
        );
        ...
        $this->add_control(
            'dropdown',
            [
                'label'        => __('Breakpoint', 'gifymo-core'),
                'type'         => Controls_Manager::SELECT,
                'default'      => 'tablet',
                'options'      => [
                    'mobile' => __('Mobile (767px >)', 'gifymo-core'),
                    'tablet' => __('Tablet (1023px >)', 'gifymo-core'),
                    'destop' => __('Destop', 'gifymo-core'),
                ],
        ...
        $this->add_control(
            'full_width',
            [
                'label'              => __('Full Width', 'gifymo-core'),
                'type'               => Controls_Manager::SWITCHER,
                'description'        => __('Stretch the dropdown of the menu to full width.', 'gifymo-core'),
        ...
        $this->add_responsive_control(
            'width_dropdown',
            [
                'label'      => __('Width Dropdown', 'gifymo-core'),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_control(
            'toggle',
            [
                'label'              => __('Toggle Button', 'gifymo-core'),
                'type'               => Controls_Manager::SELECT,
                'default'            => 'burger',
                'options'            => [
                    ''       => __('None', 'gifymo-core'),
                    'burger' => __('Hamburger', 'gifymo-core'),
                ],
        ...
        $this->add_responsive_control(
            'toggle_align',
            [
                'label'        => __('Toggle Align', 'gifymo-core'),
                'type'         => Controls_Manager::CHOOSE,
                'default'      => 'left',
                'options'      => [
                    'left'   => [
        ...
        $this->add_control(
            'menu-toggle-title',
            [
                'label'   => __('Title Toggle', 'gifymo-core'),
                'default' => 'Menu',
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Main Menu', 'gifymo-core'),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Mega Menu', 'gifymo-core'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'dot_menu_item',
            [
                'label'     => __('Dot Color', 'gifymo-core'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            'color_sub_arrow',
            [
                'label'     => __('Sub Arrow Color', 'gifymo-core'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            'bgcolor_sub_arrow',
            [
                'label'     => __('Sub Arrow Background Color', 'gifymo-core'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            'color_divider',
            [
                'label'     => __('Divider Color', 'gifymo-core'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Pointer Color', 'gifymo-core'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .elementor-nav-menu--main .elementor-item.highlighted'                  => 'background-color: {{VALUE}} ',
        ...
        $this->add_control(
            'pointer_height',
            [
                'label'     => __('Pointer Height', 'gifymo-core'),
                'type'      => Controls_Manager::SLIDER,
        ...
        $this->add_responsive_control(
            ...
            [
                'label'     => __('Horizontal Padding', 'gifymo-core'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'max' => 50,
        ...
        $this->add_responsive_control(
            ...
            [
                'label'     => __('Vertical Padding', 'gifymo-core'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'max' => 50,
        ...
        $this->add_responsive_control(
            'menu_space_between',
            [
                'label'     => __('Space Between', 'gifymo-core'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'max' => 100,
        ...
        $this->add_control(
            ...
            [
                'raw'             => __('On desktop, this will affect the submenu. On mobile, this will affect the entire menu.', 'gifymo-core'),
                'type'            => Controls_Manager::RAW_HTML,
        ...
        $this->add_control(
            'dropdown_box',
            [
                'label'     => __('Dropdown Box', 'gifymo-core'),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'dropdown_item',
            [
                'label'     => __('Dropdown Item', 'gifymo-core'),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'show_line',
            [
                'label'     => __('Show line hover', 'gifymo-core'),
                'type'      => Controls_Manager::SWITCHER,
                'default'   => '',
                'selectors' => [
