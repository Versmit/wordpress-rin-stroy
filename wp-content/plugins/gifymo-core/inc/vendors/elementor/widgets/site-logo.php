...
class OSF_Element_Site_Logo extends Widget_Image {
    ...
    public function get_title() {
        return __( 'Opal Site Logo', 'gifymo-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section_extra',
            [
                'label' => __( 'Logo Site', 'gifymo-core' ),
            ]
        );
        $this->add_control(
            'logo_select',
            [
                'label' => __( 'Image from', 'gifymo-core' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'site_logo',
                'options' => [
                    'site_logo' => __( 'Use Site Logo', 'gifymo-core' ),
                    'customize' => __( 'Custom Logo', 'gifymo-core' ),
                ]
            ]
        );
        ...
        $this->add_control(
            'caption_source',
            [
                'label' => __( 'Caption', 'gifymo-core' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'none' => __( 'None', 'gifymo-core' ),
                    'attachment' => __( 'Attachment Caption', 'gifymo-core' ),
                    'custom' => __( 'Custom Caption', 'gifymo-core' ),
                ],
                'default' => 'none',
            ]
        );
        ...
        $this->add_control(
            'caption',
            [
                'label' => __( 'Custom Caption', 'gifymo-core' ),
                'type' => Controls_Manager::TEXT,
                'default' => '',
                'placeholder' => __( 'Enter your image caption', 'gifymo-core' ),
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'none' => __( 'None', 'gifymo-core' ),
                    'file' => __( 'Media File', 'gifymo-core' ),
                    'custom' => __( 'Custom URL', 'gifymo-core' ),
                ],
            ]
        );
        ...
        $this->add_control(
            'open_lightbox',
            [
                'label' => __( 'Lightbox', 'gifymo-core' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'default',
                'options' => [
                    'default' => __( 'Default', 'gifymo-core' ),
                    'yes' => __( 'Yes', 'gifymo-core' ),
                    'no' => __( 'No', 'gifymo-core' ),
                ],
                'condition' => [
                    'link_to' => 'file',
                ],
