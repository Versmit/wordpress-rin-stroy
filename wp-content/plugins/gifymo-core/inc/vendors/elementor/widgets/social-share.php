...
class OSF_Element_Social_Share extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __('Opal Social Share', 'gifymo-core');
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            ...
            [
                'label' => __('Share Buttons', 'gifymo-core'),
            ]
        );
        ...
        $this->add_control(
            'socials',
            [
                'label'    => __('Select Socials', 'gifymo-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'type'         => Controls_Manager::SELECT,
                'options'      => [
                    'gradient' => __('Gradient', 'gifymo-core'),
                    'minimal'  => __('Minimal', 'gifymo-core'),
                    'framed'   => __('Framed', 'gifymo-core'),
                    'boxed'    => __('Boxed Icon', 'gifymo-core'),
                    'flat'     => __('Flat', 'gifymo-core'),
                ],
                'default'      => 'gradient',
        ...
        $this->add_control(
            'share_url_type',
            [
                'label'     => __('Target URL', 'gifymo-core'),
                'type'      => Controls_Manager::SELECT,
                'options'   => [
                    'current_page' => __('Current Page', 'gifymo-core'),
        ...
        $this->add_responsive_control(
            'column_gap',
            [
                'label'     => __('Columns Gap', 'gifymo-core'),
        ...
        $this->add_responsive_control(
            'button_size',
            [
                'label'     => __('Button Size', 'gifymo-core'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'min'  => 0.5,
        ...
        $this->add_responsive_control(
            'button_height',
            [
                'label'          => __('Button Height', 'gifymo-core'),
                'type'           => Controls_Manager::SLIDER,
                'range'          => [
                    'em' => [
                        'min'  => 1,
        ...
        $this->add_control(
            ...
            [
                ...
                'type'         => Controls_Manager::SELECT,
                'options'      => [
                    'official' => __('Official', 'gifymo-core'),
                    'custom'   => __('Custom', 'gifymo-core'),
                ],
                'default'      => 'official',
        ...
        $this->add_control(
            'text_padding',
            [
                'label'      => __('Text Padding', 'gifymo-core'),
                    ...
                    <div class="<?php echo esc_attr($button_classes . $social_network_class); ?>">
                        <?php if ('icon' === $settings['view'] || 'icon-text' === $settings['view']) : ?>
                            <span class="elementor-share-btn__icon">
								...
								<span class="elementor-screen-only"><?php echo sprintf(__('Share on %s', 'gifymo-core'), $network_name); ?></span>
							</span>
                        <?php endif; ?>
                        <?php if ($show_text) : ?>
