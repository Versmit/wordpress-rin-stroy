...
class OSF_Elementor_Widget_Button extends Widget_Button {
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => __('Click here', 'gifymo-core'),
            ]
        );
        ...
        $this->add_control(
            'button_css_id',
            [
                'label'       => __('Button ID', 'gifymo-core'),
                'type'        => Controls_Manager::TEXT,
                'default'     => '',
                'title'       => __('Add your custom id WITHOUT the Pound key. e.g: my-id', 'gifymo-core'),
                'label_block' => false,
                'description' => __('Please make sure the ID is unique and not used elsewhere on the page this form is displayed. This field allows <code>A-z 0-9</code> & underscore chars without spaces.', 'gifymo-core'),
                'separator'   => 'before',
        ...
        $this->start_controls_section(
            'contactform7',
            [
                'label' => __('Contact Form Popup', 'gifymo-core'),
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => __('Button Submit', 'gifymo-core'),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'contact_slug!' => '',
                ]
    ...
    protected function render() {
        ...
        if (!empty($settings['size']) && $settings['button_type'] !="link") {
