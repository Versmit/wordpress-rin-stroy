...
class OSF_Widget_Image_Box extends Widget_Image_Box {
    ...
    public function get_title() {
        return __('Image Box', 'gifymo-core');
    }
...
//        control button
        ...
        $this->add_control(
            ...
            [
                ...
                'type'        => Controls_Manager::TEXT,
                'placeholder' => __('Enter your button text', 'gifymo-core'),
                'label_block' => true,
                'default'     => 'Button',
            ]
        );
...
//        end control button
        ...
        $this->add_responsive_control(
            'image_wrapper',
            [
                'label'      => __('Wrapper Size', 'gifymo-core'),
        ...
        $this->add_responsive_control(
            'image_align',
            [
                'label'     => __('Image Alignment', 'gifymo-core'),
                'type'      => Controls_Manager::CHOOSE,
                'options'   => [
                    'flex-start' => [
                        'title' => __('Left', 'gifymo-core'),
        ...
        $this->add_control(
            'image_hover_scale',
            [
                'label'     => __('Hover Scale', 'gifymo-core'),
                'type'      => Controls_Manager::SWITCHER,
                'selectors' => [
        ...
        $this->add_responsive_control(
            'btn_text_spacing',
            [
                'label'     => __('Spacing Text', 'gifymo-core'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'min' => 0,
