...
class OSF_Widget_Icon_Box extends Widget_Icon_Box {
    ...
    public function get_title() {
        return __('Icon Box', 'gifymo-core');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'options'      => [
                    ...
                    'hexagon'   => __('hexagon', 'gifymo-core'),
                    'polygon-1' => __('Polygon 1', 'gifymo-core'),
                    'polygon-2' => __('Polygon 2', 'gifymo-core'),
                    'polygon-3' => __('Polygon 3', 'gifymo-core'),
                ],
                'default'      => 'circle',
                'condition'    => [
                    'view!' => 'default',
        ...
        $this->add_control(
            'title_text',
            [
                'label'       => __('Title, Sub Title & Description', 'gifymo-core'),
        ...
        $this->add_control(
            'link_download',
            [
                'label' => __('Donload Link ?', 'gifymo-core'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->add_control(
            'icon_inside_title',
            [
                'label'        => __('Icon Inside title ?', 'gifymo-core'),
                'type'         => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            'icon_inside',
            [
                'label'        => __('Icon Inside wrapper ?', 'gifymo-core'),
                'type'         => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            'hover_wrapper_animation',
            [
                'label' => __('Icon Spin Around', 'gifymo-core'),
                'type'  => Controls_Manager::SWITCHER,
                'prefix_class' => 'elementor-icon-spinAround-',
            ]
        );
        ...
        $this->add_responsive_control(
            'line_space',
            [
                'label'     => __('Spacing Line', 'gifymo-core'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'min' => -100,
        ...
        $this->add_responsive_control(
            'line_width',
            [
                'label'     => __('Spacing width', 'gifymo-core'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'min' => 0,
    ...
    protected function render() {
        ...
        $icon_attributes = $this->get_render_attribute_string('wrapper');
