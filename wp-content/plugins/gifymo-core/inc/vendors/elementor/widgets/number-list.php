...
class OSF_Widget_Number_List extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Number List', 'gifymo-core' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_icon',
            [
                'label' => __( 'Icon List', 'gifymo-core' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'traditional' => [
                        'title' => __( 'Default', 'gifymo-core' ),
                        'icon' => 'eicon-editor-list-ul',
                    ],
                    'inline' => [
                        'title' => __( 'Inline', 'gifymo-core' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'text' => __( 'List Item #1', 'gifymo-core' ),
                        'number' => '1',
                    ],
                    [
                        'text' => __( 'List Item #2', 'gifymo-core' ),
                        'number' => '2',
                    ],
                    [
                        'text' => __( 'List Item #3', 'gifymo-core' ),
                        'number' => '3',
                    ],
                ],
        ...
        $this->add_control(
            'text_indent',
            [
                'label' => __( 'Text Indent', 'gifymo-core' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'max' => 50,
        ...
        $this->add_control(
            'text_underline',
            [
                'label' => __( 'Show Underline', 'gifymo-core' ),
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => __( 'Underline spacing', 'gifymo-core' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => -10,
