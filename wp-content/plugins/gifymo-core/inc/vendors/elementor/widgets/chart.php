...
class OSF_Elementor_Chart extends Widget_Base
{
    ...
    {
        return __('Opal Chart', 'gifymo-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'doughnut',
                'options' => [
                    'doughnut' => __('Doughnut', 'gifymo-core'),
                    'pie' => __('Pie', 'gifymo-core'),
                ],
        ...
        $repeater->add_control(
            ...
            [
                ...
                'label_block' => true,
                'placeholder' => __('Chart Name', 'gifymo-core'),
                'default' => __('Chart Name', 'gifymo-core'),
            ]
        );
        $repeater->add_control(
            'number',
            [
                'label' => __('Nunber', 'gifymo-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'name' => __('Fundrasing', 'gifymo-core'),
                        'number' => '40',
                        'color' => '#1f9a47',
                    ],
                    [
                        'name' => __('Research and Advoccy', 'gifymo-core'),
                        'number' => '25',
                        'color' => '#37b560',
                    ],
                    [
                        'name' => __('Operations ', 'gifymo-core'),
                        'number' => '15',
                        'color' => '#68d89d',
                    ],
                    [
                        'name' => __('Education & Prevention', 'gifymo-core'),
                        'number' => '10',
                        'color' => '#6bdbc5',
                    ],
                    [
                        'name' => __('Reserve', 'gifymo-core'),
                        'number' => '5',
                        'color' => '#8de8dc',
                    ],
                    [
                        'name' => __('Smart MFG Tech', 'gifymo-core'),
                        'number' => '5',
                        'color' => '#aefff1',
                    ],
                ],
        ...
        $this->add_responsive_control(
            'width_canvas',
            [
                'label' => __('Canvas Size', 'gifymo-core'),
        ...
        $this->add_control(
            'legend_indent',
            [
                'label' => __('Legend Indent', 'gifymo-core'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'max' => 50,
        ...
        $this->add_control(
            'name_color',
            [
                'label' => __('Name Color', 'gifymo-core'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            'name_indent',
            [
                'label' => __('Name Indent', 'gifymo-core'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'max' => 50,
        ...
        $this->add_control(
            'number_color',
            [
                'label' => __('Number Color', 'gifymo-core'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
