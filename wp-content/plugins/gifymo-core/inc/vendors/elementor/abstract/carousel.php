...
abstract class OSF_Elementor_Carousel_Base extends Elementor\Widget_Base {
    ...
    protected function add_control_carousel($condition = array()) {
        $this->start_controls_section(
            ...
            [
                'label'     => __('Carousel Options', 'gifymo-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => 'dots',
                'options'   => [
                    'both'   => __('Arrows and Dots', 'gifymo-core'),
                    'arrows' => __('Arrows', 'gifymo-core'),
                    'dots'   => __('Dots', 'gifymo-core'),
        ...
        $this->add_control(
            'nav_position',
            [
                'label'        => __('Nav Position', 'gifymo-core'),
                'type'         => Controls_Manager::SELECT,
                'default'      => 'top',
                'options'      => [
        ...
        $this->add_control(
            'nav_align',
            [
                'label'        => __('Nav Align', 'gifymo-core'),
                'type'         => Controls_Manager::SELECT,
                'default'      => 'right',
                'options'      => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label'      => __('Nav Spacing Vertical', 'gifymo-core'),
        ...
        $this->add_responsive_control(
            ...
            [
                'label'      => __('Nav Spacing Horizontal', 'gifymo-core'),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    'px' => [
                        'min' => -100,
        ...
        $this->add_control(
            'pause_on_hover',
            [
                'label'     => __('Pause on Hover', 'gifymo-core'),
                'type'      => Controls_Manager::SWITCHER,
                'default'   => 'yes',
                'condition' => [
                    'enable_carousel' => 'yes'
        ...
        $this->add_control(
            'visible_item',
            [
                'label'        => __('Visible Item', 'gifymo-core'),
                'type'         => Controls_Manager::SWITCHER,
                'default'      => 'no',
                'condition'    => [
                    'enable_carousel' => 'yes'
        ...
        $this->add_control(
            'autoplay_speed',
            [
                'label'     => __('Autoplay Speed', 'gifymo-core'),
                'type'      => Controls_Manager::NUMBER,
                'default'   => 5000,
                'condition' => [
                    'autoplay'        => 'yes',
        ...
        $this->add_control(
            'infinite',
            [
                'label'     => __('Infinite Loop', 'gifymo-core'),
                'type'      => Controls_Manager::SWITCHER,
                'default'   => 'yes',
                'condition' => [
                    'enable_carousel' => 'yes'
...
//        );
        ...
        $this->add_control(
            'carousel_navs_color',
            [
                'label'     => __('Nav Background Color', 'gifymo-core'),
        ...
        $this->add_control(
            'carousel_nav_color',
            [
                'label'     => __('Arrow Color', 'gifymo-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Arrow Background Color', 'gifymo-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Arrow Border Color', 'gifymo-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
