...
class OSF_Elementor_Parallax {
    ...
    public function register_controls($element, $args) {
        ...
        $element->start_controls_section(
            ...
            [
                'label' => __('Multi Parallax ', 'gifymo-core'),
                'tab'   => Controls_Manager::TAB_LAYOUT,
            ]
        );
        $element->add_control('osf_section_parallax_switcher',
            [
                'label' => __('Enable Parallax', 'gifymo-core'),
        ...
        $repeater->add_control(
            ...
            [
                'label'   => __('Parallax Type', 'gifymo-core'),
                'type'    => Controls_Manager::SELECT,
                'options' => [
                    'image' => __('Image', 'gifymo-core'),
                    'svg'   => __('Svg', 'gifymo-core'),
                    'svg'   => __('Opal Style', 'gifymo-core'),
                ],
                'default' => 'image',
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                'label'   => __('Opal Style Color', 'gifymo-core'),
                'type'    => Controls_Manager::SELECT,
                'options' => [
        ...
        $repeater->add_control(
            ...
            [
                'label'     => __('Custom Color', 'gifymo-core'),
        ...
        $repeater->add_control(
            ...
            [
                'label'      => __('Position h', 'gifymo-core'),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    '%'  => [
                        'min' => 0,
        ...
        $repeater->add_control(
            ...
            [
                'label'      => __('Position v', 'gifymo-core'),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    '%'  => [
                        'min' => 0,
        ...
        $repeater->add_control(
            ...
            [
                'label'       => __('Z-Index', 'gifymo-core'),
                'type'        => Controls_Manager::NUMBER,
                'default'     => 1,
                'description' => __('Choose z-index for the parallax layer, default: 3', 'gifymo-core'),
            ]
        );
        $repeater->add_control(
            'osf_section_parallax_mouse',
            [
                'label'       => __('Mousemove Parallax', 'gifymo-core'),
                'type'        => Controls_Manager::SWITCHER,
                'description' => __('Enable or disable mousemove interaction', 'gifymo-core'),
            ]
        );
        $repeater->add_control(
            'osf_section_parallax_rate',
            [
                'label'   => __('Rate', 'gifymo-core'),
                'type'    => Controls_Manager::NUMBER,
                'default' => -10,
                'min'     => -20,
                'max'     => 20,
        ...
        $element->add_control(
            ...
            [
                'label'     => __('Parallax Items', 'gifymo-core'),
