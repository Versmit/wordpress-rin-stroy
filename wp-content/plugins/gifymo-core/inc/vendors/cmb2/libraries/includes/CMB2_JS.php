...
class CMB2_JS {
	...
	protected static function colorpicker_frontend() {
		...
		wp_localize_script( 'wp-color-picker', 'wpColorPickerL10n', array(
			'clear'         => esc_html__( 'Clear', 'gifymo-core' ),
			'defaultString' => esc_html__( 'Default', 'gifymo-core' ),
			'pick'          => esc_html__( 'Select Color', 'gifymo-core' ),
			'current'       => esc_html__( 'Current Color', 'gifymo-core' ),
		) );
	}
		...
		$l10n = array(
			...
			'defaults'          => array(
				...
				'date_picker'  => array(
					'changeMonth'     => true,
					'changeYear'      => true,
					'dateFormat'      => _x( 'mm/dd/yy', 'Valid formatDate string for jquery-ui datepicker', 'gifymo-core' ),
					'dayNames'        => explode( ',', esc_html__( 'Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday', 'gifymo-core' ) ),
					'dayNamesMin'     => explode( ',', esc_html__( 'Su, Mo, Tu, We, Th, Fr, Sa', 'gifymo-core' ) ),
					'dayNamesShort'   => explode( ',', esc_html__( 'Sun, Mon, Tue, Wed, Thu, Fri, Sat', 'gifymo-core' ) ),
					'monthNames'      => explode( ',', esc_html__( 'January, February, March, April, May, June, July, August, September, October, November, December', 'gifymo-core' ) ),
					'monthNamesShort' => explode( ',', esc_html__( 'Jan, Feb, Mar, Apr, May, Jun, Jul, Aug, Sep, Oct, Nov, Dec', 'gifymo-core' ) ),
					'nextText'        => esc_html__( 'Next', 'gifymo-core' ),
					'prevText'        => esc_html__( 'Prev', 'gifymo-core' ),
					'currentText'     => esc_html__( 'Today', 'gifymo-core' ),
					'closeText'       => esc_html__( 'Done', 'gifymo-core' ),
					'clearText'       => esc_html__( 'Clear', 'gifymo-core' ),
				),
				'time_picker'  => array(
					'timeOnlyTitle' => esc_html__( 'Choose Time', 'gifymo-core' ),
					'timeText'      => esc_html__( 'Time', 'gifymo-core' ),
					'hourText'      => esc_html__( 'Hour', 'gifymo-core' ),
					'minuteText'    => esc_html__( 'Minute', 'gifymo-core' ),
					'secondText'    => esc_html__( 'Second', 'gifymo-core' ),
					'currentText'   => esc_html__( 'Now', 'gifymo-core' ),
					'closeText'     => esc_html__( 'Done', 'gifymo-core' ),
					'timeFormat'    => _x( 'hh:mm TT', 'Valid formatting string, as per http://trentrichardson.com/examples/timepicker/', 'gifymo-core' ),
					'controlType'   => 'select',
					'stepMinute'    => 5,
				),
			),
			'strings' => array(
				'upload_file'  => esc_html__( 'Use this file', 'gifymo-core' ),
				'upload_files' => esc_html__( 'Use these files', 'gifymo-core' ),
				'remove_image' => esc_html__( 'Remove Image', 'gifymo-core' ),
				'remove_file'  => esc_html__( 'Remove', 'gifymo-core' ),
				'file'         => esc_html__( 'File:', 'gifymo-core' ),
				'download'     => esc_html__( 'Download', 'gifymo-core' ),
				'check_toggle' => esc_html__( 'Select / Deselect All', 'gifymo-core' ),
			),
		);
